...
{
       0,    43,    43,    45,    46,    48,    49,    50,    56,    63,
      66,    67,    69,    78,    80,    81,    83,    86,    87,    89,
      97,   106,   107,   109,   122,   124,   125,   127,   128,   129,
     133,   134,   135,   138,   139,   141,   145,   146,   148,   158,
     170,   186,   187,   188,   189,   196,   202,   208,   214,   215,
     216,   217,   232,   244,   245,   246,   254,   255,   257,   258
};
#endif
...
#line 86 "syntax_tree.y"
    {(yyval.type_tnode)=newAst("VarDec",1,(yyvsp[(1) - (1)].type_tnode)); (yyval.type_tnode)->tag=1;(yyval.type_tnode)->content=(yyvsp[(1) - (1)].type_tnode)->content;;}
    break;
...
#line 109 "syntax_tree.y"
    {
		...
		if(findvar((yyvsp[(2) - (2)].type_tnode))||findarray((yyvsp[(2) - (2)].type_tnode)))  
			...
			newarray(1,(yyvsp[(2) - (2)].type_tnode));
        else 
			newvar(1,(yyvsp[(2) - (2)].type_tnode));
	;}
    break;
...
/* Line 1455 of yacc.c  */
#line 148 "syntax_tree.y"
    {
		(yyval.type_tnode)=newAst("Dec",1,(yyvsp[(1) - (1)].type_tnode)); 
		// 错误类型7:变量出现重复定义
		if(findvar((yyvsp[(1) - (1)].type_tnode))||findarray((yyvsp[(1) - (1)].type_tnode)))  
			printf("Error type 7 at Line %d:Redefined Variable '%s'\n",yylineno,(yyvsp[(1) - (1)].type_tnode)->content);
        else if((yyvsp[(1) - (1)].type_tnode)->tag==4) 
			newarray(1,(yyvsp[(1) - (1)].type_tnode));
        else 
			newvar(1,(yyvsp[(1) - (1)].type_tnode));
	;}
    break;
...
#line 158 "syntax_tree.y"
    {
		(yyval.type_tnode)=newAst("Dec",3,(yyvsp[(1) - (3)].type_tnode),(yyvsp[(2) - (3)].type_tnode),(yyvsp[(3) - (3)].type_tnode)); 
		(yyval.type_tnode)->content=(yyvsp[(1) - (3)].type_tnode)->content;
		if(findvar((yyvsp[(1) - (3)].type_tnode))||findarray((yyvsp[(1) - (3)].type_tnode)))  
			printf("Error type 7 at Line %d:Redefined Variable '%s'\n",yylineno,(yyvsp[(1) - (3)].type_tnode)->content);
        else if((yyvsp[(1) - (3)].type_tnode)->tag==4) 
			newarray(1,(yyvsp[(1) - (3)].type_tnode));
        else 
			newvar(1,(yyvsp[(1) - (3)].type_tnode));
	;}
    break;
...
#line 217 "syntax_tree.y"
    {
		...
		// 函数实参和形参类型不一致
			...
			(yyval.type_tnode)->type=typefunc((yyvsp[(1) - (4)].type_tnode));
		}
	;}
    break;
...
#line 232 "syntax_tree.y"
    {
		...
		// 错误类型5:函数在调用时未经定义
			...
			(yyval.type_tnode)->type=typefunc((yyvsp[(1) - (3)].type_tnode));
		}
	;}
    break;
...
/* Line 1455 of yacc.c  */
#line 254 "syntax_tree.y"
    {(yyval.type_tnode)=newAst("Exp",1,(yyvsp[(1) - (1)].type_tnode)); (yyval.type_tnode)->tag=3;(yyval.type_tnode)->value=(yyvsp[(1) - (1)].type_tnode)->value;;}
    break;

  case 57:

/* Line 1455 of yacc.c  */
#line 255 "syntax_tree.y"
    {(yyval.type_tnode)=newAst("Exp",1,(yyvsp[(1) - (1)].type_tnode)); (yyval.type_tnode)->tag=3;(yyval.type_tnode)->value=(yyvsp[(1) - (1)].type_tnode)->value;;}
    break;
